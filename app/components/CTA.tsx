        ...
        <div className="w-full min-h-0 h-s rounded-sm flex flex-col gap-6">
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              ...
              <label className="flex flex-col gap-1">
                <span className="text-sm opacity-70">Тип услуги</span>
                <select
                  value={service}
              ...
              <label className="flex flex-col gap-1">
                <span className="text-sm opacity-70">Сообщение</span>
                <textarea
            ...
            <ButtonPrimary isSubmit={true}>Отправить Заявку</ButtonPrimary>
          </form>
        </div>
      </div>
