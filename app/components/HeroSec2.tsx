      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        ...
        <div className="flex flex-col gap-6 lg:gap-8 order-1 lg:order-2">
          <p className="p-medium">
            Мы устанавливаем двери, сдвижные системы, декоративные панели любой
            сложности — от замера до сдачи объекта. Более 28 000 успешно
            завершённых проектов. Гарантия на работы — 3 года. Работаем в
